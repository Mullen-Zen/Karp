...
class Parser {
    ...
    private Stmt varDeclaration() {
        ...
        consume(PIPE, "Expect '|' after variable declaration");
    ...
    private Stmt forStatement() {
        ...
        consume(PIPE, "Expect '|' after loop condition.");
